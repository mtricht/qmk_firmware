...
[_RAISE] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, _______,
  _______,  _______,   _______,    _______,   _______,    _______,        XXXXXXX,    KC_HOME,    KC_PGDOWN,    KC_PGUP, KC_END, XXXXXXX,
  _______,  _______,    _______,   _______,   _______,   _______,                       KC_LCTRL, KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT, XXXXXXX,
